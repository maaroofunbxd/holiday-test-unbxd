...
export default function () {
  ...
  if (randomPayload.query_string) {
    ...
    let url = `http://internal-a33ac7ecf86484bdb9a6a550a45a3f8d-2136975334.us-east-1.elb.amazonaws.com/v1.0/sites/${sitekey}/recommend`;
    ...
    if (randomPayload.payload.rankingContext !== undefined) {
      ...
      const url = `http://internal-a33ac7ecf86484bdb9a6a550a45a3f8d-2136975334.us-east-1.elb.amazonaws.com/v1.0/sites/${sitekey}/rerank`;
      http.post(url, JSON.stringify(randomPayload.payload), params);
    } else {
      // Without rankingContext - POST /v2.0/sites/.../recommend
      const url = `http://internal-a33ac7ecf86484bdb9a6a550a45a3f8d-2136975334.us-east-1.elb.amazonaws.com/v2.0/sites/${sitekey}/recommend`;
      http.post(url, JSON.stringify(randomPayload.payload), params);
    }
  }
}
