...
#HOST=http://$(./accesscluster.sh use-1d "./get-service-host.sh ner-demo" 2>&1 | grep -oE '[a-z0-9-]+\.[a-z0-9-]+\.elb\.amazonaws\.com' | head -1) REGION=use-1d ./accessloadtestcluster.sh @loadtestcluster-commands.sh
